...
MY_CMD="python main.py --batch_size 128 --epochs 1200 --arch resnet18 --data_name cifar10_1024_4class --train_mode auto_aug --load_model --load_model_path random_initial_model1 --augmentation_prob 1.0 0.5 0.8 ${para[${i}]} --my_train_loader --pretrain_model_path normal_45934555_2_20220220113003_0.5_200_128_model --save_aug_file_name temp2.txt --local 2 --no_save"
