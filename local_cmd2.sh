...
MY_CMD="python main5.py --batch_size 512 --epochs 100 --arch resnet18 --dataset cifar100 --data_name whole_cifar100 --train_mode train_dbindex_loss --curriculum DBindex_cluster_momentum_kmeans_wholeset --load_model --load_model_path normal_49836888_1_20220327154053_0.5_200_512_1000_model --train_data_drop_last --weight_dbindex_loss 1 --start_dbindex_loss_epoch 1 --restore_k_when_start --num_clusters 150 1000 --repeat_num 1 --use_wholeset_centroid --use_mean_dbindex --use_org_sample_dbindex --reassign_step 1 --final_high_conf_percent 0.8 --keep_gradient_on_center --inter_class_type batch --dbindex_type half --use_GT --local 1 --no_save"
