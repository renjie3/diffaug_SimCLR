...
parser.add_argument('--start_epoch', default=30, type=int, help='Use pretrained model to get DBindex')
...
# epoch,train_loss,test_acc@1,test_acc@5,best_test_acc,best_test_acc_loss,best_train_loss_acc,best_train_loss
    ...
    for name in file_names:
        ...
        # if sub_job1 in name and "_statistics.csv" in name:
            ...
            for key in results['train_loss']:
                if key > args.start_epoch and key <= args.max_epoch:
                    if results['train_loss'][key] < best_loss:
                        best_loss = results['train_loss'][key]
                        best_loss_acc = results['test_acc@1'][key]

            job1_train_loss_acc_results.append(best_loss_acc)
        ...
        if sub_job2 in name and csv_name in name:
            ...
            job2_train_loss_acc_results.append(best_loss_acc)
