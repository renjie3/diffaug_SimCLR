...
for((i=0;i<8;i++));
do
MY_CMD="python main_visualization.py --batch_size 128 --epochs 1200 --arch resnet18 --data_name cifar10_1024_4class --train_mode auto_aug --curriculum DBindex_ratio_inst_cluster_GT --load_model --load_model_path ${models1[${i}]} --my_train_loader --train_data_drop_last --attack_alpha 2  --augmentation_prob 1.0 0.5 0.8 0.2 --color_jitter_strength 0.8 --save_aug_file_name temp2.txt --attack_steps 4 --local 2 --no_save"
echo $MY_CMD
$MY_CMD
done
