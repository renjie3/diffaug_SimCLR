...
PIERMARO_MYCOMMEND="python main.py --batch_size 512 --epochs $SINGLE_EPOCH  --piermaro_whole_epoch ${WHOLE_EPOCH} --arch resnet18 --data_name cifar10_1024_4class --train_mode normal --curriculum DBindex_ratio_inst_cluster_GT --mass_candidate mass_candidate --train_data_drop_last --load_model --load_model_path random_initial_model1 --start_batch_num_ratio 0.5 --curriculum_scheduler 0_1_1 --my_data_loader"

PIERMARO_MYCOMMEND2="python main.py --batch_size 512 --epochs $SINGLE_EPOCH  --piermaro_whole_epoch ${WHOLE_EPOCH} --arch resnet18 --data_name cifar10_1024_4class --train_mode normal --curriculum DBindex_ratio_inst_cluster_GT --mass_candidate mass_candidate --train_data_drop_last --load_model --load_model_path random_initial_model1 --start_batch_num_ratio 0.5 --curriculum_scheduler 0_1_1 --my_data_loader --reorder_reverse"
